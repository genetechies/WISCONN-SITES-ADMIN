        ...
        <asp:Button ID="btnReset" runat="server" Text="重置" OnClick="btnReset_Click" />
            ...
            <table class="table_textcenter">
                <tr>
                    ...
                    <td align="center" width="20%" style="font-weight: bold">Keywords</td>
                    <td align="center" width="20%" style="font-weight: bold">Description</td>
                ...
                <asp:Repeater ID="rpt_list" runat="server" OnItemDataBound="rpt_list_ItemDataBound">
                    <ItemTemplate>
                        <tr>
                            ...
                            <td align="center" width="20%"><%#Eval("Keywords") %></td>
                            <td align="center" width="20%"><%#Eval("Description") %></td>
