...
<head runat="server">
    ...
    <script type="text/javascript">
        ...
        function clearSearchText(searchText){
	        if(document.getElementById(searchText).value=="查詢網頁訊息"){
		...
		<table width="100%" border="0" cellpadding="0" cellspacing="0" style="border:1px solid #BDC9D6;height:35px">
		  <tr>
			...
			<table width="95%" border="0" cellpadding="0" cellspacing="0" style="margin-left:20px;">
			  <tr>
				<td style="width: 300px">網頁管理 > 網頁列表</td>
				<td align="right">
				    <asp:DropDownList ID="ddlCategory" runat="server" >
		                <asp:ListItem Text="請選擇分類" Value="-1"></asp:ListItem>
		             </asp:DropDownList>&nbsp;&nbsp;
		             <asp:TextBox ID="searchText1" runat="server" style="vertical-align:middle" onfocus="javascript:clearSearchText('searchText1');" Text="查詢網頁訊息"></asp:TextBox>&nbsp;<asp:Button 
...
&nbsp;</td>
             ...
             <asp:Repeater ID="productGrid" runat="server" OnItemCommand="productGrid_ItemCommand" OnItemDataBound="productGrid_ItemDataBound">
                    <ItemTemplate>
                            <tr bgcolor="#FFFFFF">
                                ...
                                <td><%#Eval("parentclassname").ToString().Equals("") ? "根目錄" : Eval("parentclassname")%></td>
                                <td><%#Eval("username")%></td>
                                
                                <td>
                                    <asp:Label ID="lblPID" runat="server" Text='<%#Eval("classid") %>' Visible="false"></asp:Label>
        ...
        <div class="tablelisthead">
             <ul>
                    ...
                    <li class="li_15">[<asp:LinkButton ID="btnDelAll" runat="server" OnClientClick="return confirm('確定要徹底刪除選擇的網頁嗎');" style="color:#888888" OnClick="btnDelAll_Click" ToolTip="刪除選擇的網頁" >刪除所選</asp:LinkButton>]</li>
                    <li class="li_15">&nbsp;</li>
                    <li class="li_10">&nbsp;</li>
                    <li class="li_5">&nbsp;</li>
                    <li class="li_10">&nbsp;</li>
