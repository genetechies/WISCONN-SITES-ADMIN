...
<li><a href="../japanese-houguan-translation-index.aspx" target="_blank" class="topbar1" title="打開網站前台首頁">回到前台</a></li>
<li><asp:LinkButton ID="btnLogOut" runat="server" CssClass="topbar4" ToolTip="退出管理後台" OnClick="Quit_Click">登出</asp:LinkButton></li>
</ul>
</div>
...
<div class="stagelevel" id="menu999" onclick="level_clickmenu('menu999');"><a href="Manager/Manage.aspx" target="main-frame" title="後台管理員"></a></div>
<div class="stagefresh"><a href="javascript:reloadMain();" title="刷新"></a></div>
<div class="stageindex" id="menu0" onclick="home_clickmenu('menu0');"><a href="WebInfo.aspx" target="main-frame" title="後台首頁"></a></div>
