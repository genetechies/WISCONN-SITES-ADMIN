                ...
                while (fileReader.EndOfStream == false)
                {
                    ...
                    if (line != "")
                    {
                        ...
                        else
                        {
                            ...
                            //else
                            //{
                            moguopic.title = y[1].Trim();
                            moguopic.Sort = (new BLL.guopic().Count("1=1") + 1);
                            moguopic.guoclassid = gouid;
                            moguopic.pic = "'UploadFiles/" + y[2].Trim() + "'";

                            DataTable table = bllguopic.GetList(" id=" + y[0].Trim()).Tables[0];
                            if (table != null && table.Rows.Count > 0)
                            {
                                moguopic.id = Convert.ToInt32(y[0].Trim());
                                bllguopic.Update(moguopic);
                            }
                            else
                            {
