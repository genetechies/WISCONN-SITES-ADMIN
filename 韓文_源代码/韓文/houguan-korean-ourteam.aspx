<%@ Page Language="C#" AutoEventWireup="true" CodeFile="houguan-korean-ourteam.aspx.cs" Inherits="houguan_korean_ourteam" %>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
	<head runat="server">
		<meta content="text/html;charset=utf-8" http-equiv="content-type" />
		<meta name="description" content="后冠韓文翻譯社的韓文翻譯團隊有多年經驗，不僅保留了自己的特色，還不斷吸取行業內的經驗，以此完善自我。此外，后冠韓文翻譯團隊還有母語譯者的加入，更讓后冠如虎添翼，為翻譯服務的品質增添了保障。" />
		...
		<![endif]-->
		<title>后冠韓文翻譯社—打造頂級韓文翻譯團隊</title>
	</head>
<body>
...
<!-- __________________________________________________ Start Content -->
						...
						<div class="content_wrap sidebar_left">
							<div id="content" class="fr">
								<div class="entry">
									<h1>后冠韓文翻譯社擁有優質的韓文翻譯團隊</h1>
                                    <p>后冠韓文翻譯社的翻譯團隊來自兩岸三地，每一位翻譯人員都是經過千挑萬選，他們不光有深厚的翻譯能力，還有良好的職業素質，能夠保障翻譯文件的準確性，也能保障文件的保密性；此外，韓文翻譯還有韓文母語譯者的加入，他們都是從韓國留學歸來或者在韓國生活多年的譯者，能夠切身瞭解韓文的特點，保證翻譯的貼切專業。</p>
                                        ...
                                        <div class="entry">
                                            ...
                                            <div class="ourtrem">
                                                 <ul class="ourtrem-ul">
                                                    ...
                                                    <ItemTemplate>
                                                     <li>
                                                          <div class="img" style="text-align:center;"><img src="<%#Eval("imgpath").ToString().Trim().Equals("") ? "" : Eval("imgpath")%>" alt="韓文翻譯" width="120"/></div>
                                                           <p class="tit">譯者簡介</p>
                                                          <p class="tname"><%#Eval("tname").ToString().Trim().Equals("") ? "" : Eval("tname")%></p>
                                                          <p class="descss"><%#Eval("avater").ToString().Trim().Equals("") ? "" : Eval("avater").ToString() == "0" ? "男" : "女"%></p>
                                                     </li>
                                                          </ItemTemplate>
                                                </asp:Repeater>
							...
							<div id="sidebar" class="fl">
								<div class="one_first">
									<div class="widget widget_custom_latest_popular_recent_entries">
										<h2 class="widgettitle"><img src="images/L-001.png" alt="韓文翻譯" width="30" height="27"/>后冠韓文翻譯社</h2>
										<div class="tab lpr">
													...
													<ul>
                                                        ...
                                                        <%System.Data.DataSet dsleft = new DAL.TransTeam().GetAllTeamType();
                                                          for (int i = 0; i < dsleft.Tables[0].Rows.Count; i++)
                                                          {
                                                             ...
                                                             %>
                                                         <li class="li1"><a href="houguan-korean-ourteam.aspx?cid=<%=dsleft.Tables[0].Rows[i]["NC_Id"].ToString().Trim() %>"><%=t[0].Trim()%></a></li>
                                                          <%} %>
													</ul>
												</div>
											</div>
