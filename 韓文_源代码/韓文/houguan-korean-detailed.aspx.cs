...
public partial class houguan_korean_detailed : System.Web.UI.Page
{
    ...
    private void BindModel(int id)
    {
        ...
        Title = "[" + newsClass.ClassName + "]" + model.D_Title + "-后冠韓文翻譯社";
    }
    ...
    private void Bindlist()
    {
        ...
        for (int i = 0; i < ds.Tables[0].Rows.Count; i++)
        {
            ...
            NewsList += "<li><a href=\"houguan-korean-detailed.aspx?id=" + ds.Tables[0].Rows[i]["D_ID"].ToString() + "\">" + title + "</a></li>";
        }
    }
    ...
    private void BindSimilar(int id)
    {
        ...
        if (ds.Tables[0].Rows.Count > 0)
        {
            for (int i = 0; i < ds.Tables[0].Rows.Count; i++)
            {
                SimilarNews += "<a href=\"houguan-korean-detailed.aspx?id=" + ds.Tables[0].Rows[i]["D_ID"].ToString() + "\" >" + ds.Tables[0].Rows[i]["D_Title"].ToString() + "</a> <br />";
            }
        }
    ...
    private void BindNext(int id)
    {
        ...
        {
            NextNews = "<a href=\"houguan-korean-detailed.aspx?id=" + ds1.Tables[0].Rows[0]["D_ID"].ToString() + "\" >" + ds1.Tables[0].Rows[0]["D_Title"].ToString() + "</a>";
        }
        else
        {
        ...
        {
            LastNews = "<a href=\"houguan-korean-detailed.aspx?id=" + ds2.Tables[0].Rows[0]["D_ID"].ToString() + "\" >" + ds2.Tables[0].Rows[0]["D_Title"].ToString() + "</a>";
        }
        else
        {
