<%@ Page Language="C#" AutoEventWireup="true" CodeFile="houguan-korean-detailed.aspx.cs" Inherits="houguan_korean_detailed" %>
									...
									<div class="blog">
                                        <div class="post hentry format-standard">
											<div class="entry-meta">
												<ul class="cmsms_tags">
													<li><a href="javascript:void(0)">作者：<%=author %></a></li>
													<li><a href="javascript:void(0)">發布日期：<%=adddate %></a></li>
                                                    <li><a href="javascript:void(0)">點擊量：<%=clickcount %></a></li>
												</ul>
											</div>
										</div>                                         
...
<%=SimilarNews %></p>  			<br/>
              ...
              <p style="padding-left:20px;">最專業的翻譯社<br/>
              后冠韓文翻譯社：<a href="https://www.translations-kr.com/">https://www.translations-kr.com/</a><br/>
              連絡電話：(02)2568-3677客服信箱：service@crowns.com.tw<br/>
              </p>
              <p style="padding-left:20px;">
                <span style="margin-top: 30px; margin-bottom: 30px;">上一篇：<%=NextNews%><br />
                                                            </span>下一篇：<%=LastNews %>
              </p>
             <p style="padding-left:20px;">我們會不斷的提供最新的翻譯資訊，各篇文章也歡迎轉載(若為同業需簽定轉載同意書)，轉載時請您記得在文章結尾附上出處與官方超連結。附上出處的方式如下：
            文章來源 ：<a href="https://www.translations-kr.com/">后冠韓文翻譯社</a> <a href="https://www.translations-kr.com/">（https://www.translations-kr.com/）</a></p>
										</div>
