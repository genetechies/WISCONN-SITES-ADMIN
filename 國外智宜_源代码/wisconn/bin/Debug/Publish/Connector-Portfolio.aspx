<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Connector-Portfolio.aspx.cs" Inherits="ZeroStudio.Web.Portfolio_en" %>
...
<head>
    ...
    <title>Wisconn  Connector - Information  for <%= title %></title>
                                    ...
                                    <div class="hm_blog_list clearfix">
                                        <div class="blog_grid_block clearfix">
                                            <div class="blog_grid_con">
                                                <h6 class="title">
                                                    <a href='Connector-Portfolio-detail.aspx?N_Id=<%#Eval("N_Id") %>'>
