<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ImageUpload.aspx.cs" Inherits="ZeroStudio.Web.Admin.Product.ImageUpload" %>
                    ...
                    <tr>
                        <td class="LineRightBlue1">
                            <table width="95%" border="0" cellpadding="0" cellspacing="0" style="margin-left: 20px;">
                                <tr>
                                    <td width="88%" height="24">產品管理 > 圖片批量上傳</td>
                            ...
                            <table width="100%" border="0" cellspacing="0" cellpadding="0" class="Font">
                                <tr class="secondalt">
                                    ...
                                    <td style="padding-top: 3px; padding-bottom: 3px;">
                                        <div style="line-height: 18px;"><b>(1)</b> 最佳解析度564*423;</div>
                                        <div style="line-height: 18px;"><b>(2)</b> 最佳圖片大小為100kb內，支持jpg，每次可上傳總批量爲5Mb;</div>
                                    </td>
                                </tr>
                                <tr class="secondalt">
                                        ...
                                        <div class="wrapper" style="height:600px">
                                            <div id="tabhead" class="tabhead">
                                                <span class="tab focus" data-content-id="upload">
                                                    <var id="lang_tab_upload">上傳圖片</var></span>
                                            </div>
        ...
        uploader.on('all', function (type, files) {
            switch (type) {
                ...
                case 'startUpload':
                    /* 添加额外的GET参数 */
                    var params = '',
                        url = "/admindanny/ueditor/net/controller.ashx?action=imageUpload";
