<%@ page language="C#" autoeventwireup="true" CodeFile="Main.aspx.cs" inherits="ZeroStudio.Web.Admin.Main" %>
...
<script language="javascript" src="../js/quickView.js" type="text/javascript" charset="utf-8" ></script>
...
<li><asp:LinkButton ID="btnLogOut" runat="server" CssClass="topbar4" ToolTip="退出管理後臺" OnClick="Quit_Click">退出登錄</asp:LinkButton></li>
</ul>
</div>
...
<ul class="navlist">
    <li><a href="Product/Manage.aspx" target="main-frame"><span>產品專區</span></a></li>
    <li><a href="News/Manage.aspx" target="main-frame"><span>連接器介紹</span></a></li>
    <li><a href="Manager/Manage.aspx" target="main-frame"><span>用戶管理</span></a></li>
    <li><a href="GuestBook/Manage.aspx" target="main-frame"><span>聯絡我們</span></a></li>
    <!--<li><a href="Manager/Manage.aspx" target="main-frame"><span>帳戶權限</span></a></li>-->
</ul></div>
</div></div>
<div id="ddsubmenuall">
</div>
          <script type="text/javascript" src="../js/ddlevelsmenu.js" charset="utf-8"></script>
          <script type="text/javascript">ddlevelsmenu.setup("ddtopmenubar", "topbar")</script>
          <script type="text/javascript">
ddlevelsmenu.arrowpointers.rightarrow[0]='images/blue_2010/arrow-right.gif'; 

function reloadDdlevelsmenu() {
