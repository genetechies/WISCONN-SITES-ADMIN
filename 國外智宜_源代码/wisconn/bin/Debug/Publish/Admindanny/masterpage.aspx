<%@ Page Language="C#" AutoEventWireup="true" CodeFile="masterpage.aspx.cs" Inherits="ZeroStudio.Web.Admin.masterpage" %>
...
<head runat="server">
  ...
  <frameset cols="197,6,*" framespacing="0" border="0" id="frame-body">
    <frame src="Left.aspx" id="menu-frame" name="menu-frame" frameborder="no" scrolling="no">
