<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Connector-Portfolio-detail.aspx.cs" Inherits="ZeroStudio.Web.Portfolio_detail_en" %>
            ...
            <section class="content_section">
                <div class="content row_spacer">
                    <div class="main_title centered upper">
                        <h2><span class="line"><span class="dot"></span></span>From The Blog</h2>
                    </div>
                    <div class="product clearfix">
                        <div class="p_left">
                            <div class="p_title">
                                <p class="toggleMenu">From The Blog</p>
                            </div>
                            ...
                            <ul class="p_toggle list_drop dn">
                                    ...
                                    <span class="no">
                                        <ul class="list_menu" style="display: block;">
                                            <asp:Repeater ID="Repeater1" runat="server">
                                                <ItemTemplate>
                                                    <li>
                                                        <a href="Connector-Portfolio.aspx?ClassID=<%#Eval("NC_Id") %>"><i></i><%#Eval("NC_ClassName") %> </a>
                                                    </li>
                                                </ItemTemplate>
                                            </asp:Repeater>
                                        </ul>
                                ...
                                <li>
                                    <div class="p_category">
                                        <span class="label">CONNECTOR PRODUCT</span>
                                        <span class="arrow up"></span>
                                    </div>
                                    <span class="no">
                                        <ul class="list_menu" style="display: block;">
                                            <%
                                                ...
                                                {%>
                                            <li><a href='Connector-Products-sublist.aspx?PC_Id=<%=parent.PC_Id%>'><i></i><%=parent.PC_ClassNameEn %> </a></li>
                                            <% }
                                            %>
                                        </ul>
                                    </span>
                    ...
                    <div class="content_spacer clearfix">
                        <div class="content_block col-md-8 f_right">
                            ...
                            <ul class="crumb">
                                ...
                                <li>
                                    <a href="/Connector-Portfolio.aspx">From The Blog</a>
                                <i class="ico-angle-right"></i>
                                </li>
                                 <li>
                                     <%
                                         if (classInfo != null) {  %>
                                       <a href="/Connector-Portfolio.aspx?ClassID=<%=classInfo.Id %>"><%=classInfo.ClassName %></a>
                                        <%   }
                                         %>
                                </li>
                            ...
                            <div class="Portfolio-contact">
                                ...
                                <p>
                                    <b>Author：<%=author %> / time：<%=datetime %> / The number of clicks：<%=hitnum %></b>
                                </p>
                                <%=content %>
                            </div>
                            <div>
                                <div style="width: 100%; ">
                                    <div class="thirddaryContent_top_2" style="margin: 10px 60px; float: left">
                                        <a href="Connector-Products-list.aspx?PC_Id=<%=pcId %>"
                                            target="_blank">
                                            <%=productName %></a>
                                    </div>
                                    <div class="thirddaryContent_top_2" style="margin: 10px 40px; float: left">
                                        <a href="Connector-Contact.aspx" target="_blank">CONTACT US
                                        </a>
                                    </div>
                                </div>
                            </div>
                        ...
                        <aside id="sidebar" class="col-md-4 right_sidebar">
                            ...
                            <ul>
                                <asp:Repeater ID="newsClassList" runat="server">
                                    <ItemTemplate>
                                        <li>
                                            <a href="Connector-Portfolio.aspx?ClassID=<%#Eval("NC_Id") %>"><%#Eval("NC_ClassName") %> </a>
                                        </li>
                                    </ItemTemplate>
                                </asp:Repeater>
                            </ul>
