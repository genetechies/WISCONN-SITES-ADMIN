...
namespace adminaspx.transzone
{
    public partial class Edit : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            model = bll.GetModelNew(Convert.ToInt32(Request.QueryString["P_id"].Split(',')[0]), new BLL.SubWeb().GetModel(Convert.ToInt32(Request.QueryString["P_id"].Split(',')[1])));
            if (!IsPostBack)
            {
        ...
        protected void Sub_Click(object sender, EventArgs e)
        {
            ...
            Model.newsdata model = new Model.newsdata();
            model.D_ID = Convert.ToInt32(Request.QueryString["P_id"].Split(',')[0]);
            ...
            bll.UpdateNew(model, new BLL.SubWeb().GetModel(Convert.ToInt32(Request.QueryString["P_id"].Split(',')[1])));
        ...
        protected void btnCloseAricle_Click(object sender, EventArgs e)
        {
            ...
            if (strKey != "")
            {
                if (strKey.Contains(","))
                {
                    ...
                    {
                        strContent += "<a href='https://www.legal-translationservices.com//translationteam/index-" + table.Rows[i]["D_Id"].ToString() + ".aspx'>" + table.Rows[i]["D_Title"].ToString() + "</a> <br />";
                    }
                }
                else
                {
