...
<body>
    ...
    <tr>
    <td class="table_tittle"  colspan="8">友好連結管理</td>
    <td colspan="3"><strong><a href="add.aspx" >>>新增友好連結</a></strong></td>
    </tr>
    <tr>
        <td colspan="3" style="height:30px;line-height:30px; text-align:right" >發佈網站</td>
...
<%--    <td align="center">子網站</td>--%>
    ...
    <ItemTemplate>
    <tr>
    <td align="center" width="35"><asp:CheckBox ID="cbSelect" runat="server" /><asp:Label ID="lblNID" runat="server" Visible="false" Text='<%#Eval("F_Id") %>' ></asp:Label>
    <asp:Label ID="lblLCTION" runat="server" Visible="false" Text='<%#Eval("F_Location")+"|"+Eval("SwId")%>' ></asp:Label>
    </td>
...
<%--    <td align="center"><%#Eval("Database")%></td>--%>
    <td align="center">
       ...
       [<a href="Edit.aspx?N_id=<%#Eval("F_Id") %>&SwId=<%#Eval("SwId") %>">修改</a>]
    </td>
    <td align="center">
           [<asp:LinkButton ID="Del" CommandArgument='<%#Eval("F_Id")+"|"+Eval("SwId")%>' runat="server" OnCommand="Del_Click" OnClientClick="return confirm('確定要刪除嗎?');">刪除</asp:LinkButton>]
    </td>
    </tr>
    </ItemTemplate>
    </asp:Repeater>
