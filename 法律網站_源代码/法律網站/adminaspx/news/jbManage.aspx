<%@ Page Language="C#" AutoEventWireup="true" CodeFile="jbManage.aspx.cs" Inherits="Web.Admin.Product.Manage" %>
...
<body>
    ...
    <tr>
        <td colspan="6" style="height:30px;line-height:30px;" >標題：
    ...
    <tr>
    <td align="center" width="35">編號</td>
    ...
    <td align="center">						
        <a href="jbEdit.aspx?P_id=<%#Eval("classid") %>" title="編輯"   >編輯</a>&nbsp;&nbsp;
    </td>
    <%--<td align="center">
    ...
    <tr>
       <td colspan="6" align="right"> <%--<input type="checkbox" onclick="SelectAll(this);" />全選 
