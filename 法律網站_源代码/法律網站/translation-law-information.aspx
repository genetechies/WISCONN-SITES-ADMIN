<%@ Page Language="C#" AutoEventWireup="true" CodeFile="translation-law-information.aspx.cs" Inherits="translation_law_information" %>
...
<meta name="Description" content="法律合約翻譯資訊是后冠在法律翻譯領域不斷探求所積累的智慧結晶，是深度交流後獲得的經驗。不論是法律合約中翻英、法律合約英翻中或是其他語言翻譯，都能提供客戶最優惠的價格，以及最具競爭力的行情。"/>
<meta name="keywords" content="法律合約中翻英,法律合約英翻中"/>    
<!-- Stylesheets-->
        ...
        <div class="header-section">
            ...
            <div class="logo">
            	<div class="logo-wrapper">
            		<a href="translation-law-index.aspx"><img src="images/logo.png" alt="法律合約中翻英" height="103" width="150" /></a>
                </div>
            </div>
            <!--End-->
...
<asp:Repeater ID="rep_list" runat="server">
    ...
    <div class="index_v_list">
    <ul class="index_v_list_name"> 
    <li><a href="translation-law-information-Detailed.aspx?id=<%# Eval("D_Id") %>" ><%# Eval("D_Title")%></a><span><%# Eval("D_Time", "{0:yyyy-MM-dd}")%></span></li>
    <li style="color:#999; font-size:12px;"><%# Eval("D_Description")%>
    </li>
    </ul>
    </div>
...
<ul class="index_v_list_name"> 
<li style="font-size:12px; text-align:center;"><div id="AspNetPager1">
                    ...
                    <div class="footer-content">
                      ...
                      <div class="footer-top">
                            ...
                            <div class="footer-about">
                                <div><img src="images/ar.png" alt="法律合約英翻中" /></div>
