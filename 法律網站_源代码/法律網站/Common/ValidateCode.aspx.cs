...
public partial class Common_ValidateCode : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        Response.Cache.SetCacheability(HttpCacheability.NoCache);
        string vNum = GenerateCheckCode();        
        CurrentAccount.SetValidateCode(vNum);
        this.CreateCheckCodeImage(vNum);
    }
