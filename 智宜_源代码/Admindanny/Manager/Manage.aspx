<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Manage.aspx.cs" Inherits="ZeroStudio.Web.Admin.Manager.Manage" %>
                        ...
                        <tr>
                            ...
                            <td class="lanyuds" align="center">
                                <asp:LinkButton ID="LB1" CommandName='<%#Eval("M_id") %>' OnCommand="Del_Click" runat="server"
                                    OnClientClick="return confirm('確定刪除嗎?')" >刪除</asp:LinkButton></td>
                        </tr>
                    </ItemTemplate>
                </asp:Repeater>
            </table>
