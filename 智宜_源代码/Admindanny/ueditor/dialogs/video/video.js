...
(function(){
    ...
    /**
     * 监听确认和取消两個按钮事件，用户执行插入或者清空正在播放的视频实例操作
     */
    ...
    function insertUpload(){
        ...
        if (count) {
            $('.info', '#queueList').html('<span style="color:red;">' + '还有2個未上傳檔案'.replace(/[\d]/, count) + '</span>');
            return false;
        } else {
