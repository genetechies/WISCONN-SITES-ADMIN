...
namespace ZeroStudio.Web {
    public partial class Contact_en : System.Web.UI.Page {
        ...
        protected void btnSend_Click(object sender, EventArgs e) {
            string mailto = "sales@wisconn.com.tw";
            ...
            reset();
            ClientScript.RegisterStartupScript(GetType(), "success", "alert('發送成功！');", true);
        }
        private void reset() {
            txtUserName.Text = "";
            txtTitle.Text = "";
        ...
        private void SendMail(string username, string email, string subject, string content, string mailto) {
            ...
            sender = new System.Net.Mail.MailAddress("houguan2017@gmail.com", "國內智宜網站線上留言", System.Text.Encoding.UTF8);
