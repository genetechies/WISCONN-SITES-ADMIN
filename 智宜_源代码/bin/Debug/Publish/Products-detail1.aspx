<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Products-detail1.aspx.cs" Inherits="ZeroStudio.Web.Products_detail_en1" %>
                        ...
                        <div class="content_block col-md-9 f_right">
                            <div class="icon_boxes_con product_boxes style1 clearfix">
                                <ul class="crumb">
                                    ...
                                    <li>
                                        <a href="/Products.aspx">Connector Product</a>
                                        <i class="ico-angle-right"></i>
                                    </li>
                                    <li>
