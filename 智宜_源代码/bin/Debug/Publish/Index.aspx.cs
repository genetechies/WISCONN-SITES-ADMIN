...
namespace ZeroStudio.Web {
    public partial class Index_en : System.Web.UI.Page {
        ...
        protected void Page_Load(object sender, EventArgs e) {
            if (!IsPostBack) {
                ...
                if (pclass != null) {
                    ...
                    HyperLink1.NavigateUrl = "Products-list.aspx?PC_Id=" + pclass.PC_Id;
                } else {
                ...
                if (pclass != null) {
                    ...
                    HyperLink2.NavigateUrl = "Products-list.aspx?PC_Id=" + pclass.PC_Id;
                } else {
                ...
                if (pclass != null) {
                    ...
                    HyperLink3.NavigateUrl = "Products-list.aspx?PC_Id=" + pclass.PC_Id;
                ...
                if (pclass != null) {
                    ...
                    HyperLink4.NavigateUrl = "Products-list.aspx?PC_Id=" + pclass.PC_Id;
                ...
                if (pclass != null) {
                    ...
                    HyperLink5.NavigateUrl = "Products-list.aspx?PC_Id=" + pclass.PC_Id;
                ...
                if (pclass != null) {
                    ...
                    HyperLink6.NavigateUrl = "Products-list.aspx?PC_Id=" + pclass.PC_Id;
                } else {
        ...
        public void Bind(Repeater repeater, int parentID) {
            DataTable table = DbHelperOledb.GetDataTable("select top 5 * from ProductClass where PC_ParentID_Zh=" + parentID + " order by PC_SortKey");
