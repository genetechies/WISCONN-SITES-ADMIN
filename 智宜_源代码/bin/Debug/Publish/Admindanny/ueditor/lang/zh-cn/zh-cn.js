...
UE.I18N['zh-cn'] = {
    'labelMap':{
        ...
        'mergecells':'合并多個单元格', 'deletetable':'删除表格', 'cleardoc':'清空文档','insertparagraphbeforetable':"表格前插入行",'insertcode':'代码语言',
        'fontfamily':'字体', 'fontsize':'字号', 'paragraph':'段落格式', 'simpleupload':'单图上傳', 'insertimage':'多图上傳','edittable':'表格属性','edittd':'单元格属性', 'link':'超链接',
    ...
    'cancel':"取消",
    'closeDialog':"关闭对话框",
    'tableDrag':"表格拖动必须引入uiUtils.js檔案！",
    'autofloatMsg':"工具栏浮动依赖编辑器UI，您首先需要引入UI檔案!",
    'loadconfigError': '获取后台配置项请求出错，上傳功能将不能正常使用！',
    'loadconfigFormatError': '后台配置项返回格式出错，上傳功能将不能正常使用！',
    'loadconfigHttpError': '请求后台配置项http错误，上傳功能将不能正常使用！',
    'snapScreen_plugin':{
        'browserMsg':"仅支持IE浏览器！",
        'callBackErrorMsg':"服务器返回数据有误，请检查配置项之后重试。",
        'uploadErrorMsg':"截图上傳失败，请检查服务器端环境! "
    },
    'insertcode':{
        'as3':'ActionScript 3',
        'bash':'Bash/Shell',
    ...
    'background':{
        ...
        'noUploadImage':"当前未上傳过任何圖片！",
        'toggleSelect':"单击可切换選中状态\n原图尺寸: "
    },
    //===============dialog i18N=======================
    'insertimage':{
        'static':{
            'lang_tab_remote':"插入圖片", //节点
            ...
            'lang_input_align':'圖片浮动方式：',
            'lang_imgLoading':"　圖片加载中……",
            'lang_start_upload':"開始上傳",
            'lock':{'title':"锁定宽高比例"}, //属性
            'searchType':{'title':"圖片类型", 'options':["新闻", "壁纸", "表情", "头像"]}, //select的option
        ...
        'imageLoadError':"圖片加载失败！请检查链接地址或网络状态！",
        'searchRemind':"请输入搜索关键词",
        'searchLoading':"圖片加载中，请稍后……",
        'searchRetry':" :( ，抱歉，没有找到圖片！请重试一次！"
    },
    'attachment':{
        'static':{
    ...
    'insertvideo':{
        ...
        'delFailSaveFile':'移除保存失败檔案',
        'statusPrompt':' 個檔案已上傳！ ',
        'flashVersionError':'当前Flash版本过低，请更新FlashPlayer后重试！',
        'flashLoadingError':'Flash加载失败!请检查路径或网络状态',
        'fileUploadReady':'等待上傳……',
        'delUploadQueue':'从上傳队列中移除',
        'limitPrompt1':'单次不能選擇超过',
        'limitPrompt2':'個檔案！请重新選擇！',
        'delFailFile':'移除失败檔案',
        'fileSizeLimit':'檔案大小超出限制！',
        'emptyFile':'空檔案无法上傳！',
        'fileTypeError':'檔案类型不允许！',
        'unknownError':'未知错误！',
        'fileUploading':'上傳中，请等待……',
        'cancelUpload':'取消上傳',
        'netError':'网络错误',
        'failUpload':'上傳失败!',
    ...
    'charts':{
        'static':{
            ...
            'lang_chart_data_unit_description': '显示在每個数据点上的数据的单位， 比如： 温度的单位 ℃',
    ...
    'help':{
        'static':{
            ...
            'lang_Txt_func':'功能',
            'lang_Txt_bold':'给選中字设置为加粗',
            'lang_Txt_copy':'复制選中内容',
            'lang_Txt_cut':'剪切選中内容',
            'lang_Txt_Paste':'粘贴',
            'lang_Txt_undo':'重新执行上次操作',
            'lang_Txt_redo':'撤销上一次操作',
            'lang_Txt_italic':'给選中字设置为斜体',
    ...
    'wordimage':{
        'static':{
            ...
            lang_step:"1、點擊顶部复制按钮，将地址复制到剪贴板；2、點擊添加照片按钮，在弹出的对话框中使用Ctrl+V粘贴地址；3、點擊打开后選擇圖片上傳流程。"
        },
        'fileType':"圖片",
        'flashError':"FLASH初始化失败，请检查FLASH插件是否正确安装！",
        'netError':"网络连接错误，请重试！",
        'copySuccess':"圖片地址已经复制！",
        'flashI18n':{} //留空默认中文
    },
    'autosave': {
        'saving':'保存中...',
