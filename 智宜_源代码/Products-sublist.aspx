<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Products-sublist.aspx.cs" Inherits="ZeroStudio.Web.Products_sublist_en" %>
                                    ...
                                    <ItemTemplate>
                                        <div class="col-md-4">
                                            <div class="service_box">
                                                <div class="icon">
                                                    <a href='javascript:void(0)' onclick="openDetail('<%#Eval("P_Id_Zh") %>','<%#Eval("P_Model") %>')">
                                                ...
                                                <div class="service_box_con">
                                                    <h3 class="centered" style="margin-top: 50px">
                                                        ...
                                                        <a href='javascript:void(0)' onclick="openDetail('<%#Eval("P_Id_Zh") %>','<%#Eval("P_Model") %>','<%#Eval("P_Doc") %>')"><%#Eval("P_Model") %></a>
                                                    ...
                                                    <%-- <ul class="desc">
                                                        <li><a href='Products-detail.aspx?P_Id=<%#Eval("P_Id") %>' target="_blank"><span><%#Eval("P_Model") %></span></a></li>
                                                    </ul>--%>
                                                </div>
                                            </div>
                                        </div>
                                ...
                                <asp:Repeater ID="cateList" runat="server">
                                    <ItemTemplate>
                                        <div class="col-md-4">
                                            <div class="service_box">
                                                <div class="icon">
                                                    <a href='Products-sublist.aspx?PC_Id=<%#Eval("PC_Id") %>'>
                                                        <img src='<%#Eval("PC_ImageUrl") %>' alt='<%#Eval("PC_ClassName") %>' /></a>
                                                </div>
                                                <div class="service_box_con">
                                                    <h3 class="centered" style="margin-top: 50px">
