...
<table  id="main" >
  ...
  <tr>
    <td class="slidebar"><img src="images/collapse.gif" alt="遊戲翻譯"  id="Img_5"  style="vertical-align:middle" onclick="SetExpand('5');"/><a onclick="SetExpand('5');" href="#" >&nbsp;&nbsp;基本訊息</a></td>
  </tr>
  <tr>
...
<table width="100%" class="leftmenutable">
  <tr>
    <td class="slidebar"><img src="images/collapse.gif" alt="遊戲翻譯"  id="Img_1"  style="vertical-align:middle" onclick="SetExpand('1');"/><a onclick="SetExpand('1');" href="#" >&nbsp;&nbsp;前台網頁管理</a></td>
  </tr>
  <tr>
...
<table width="100%" class="leftmenutable" id="eight" runat="server">
  <tr>
    <td class="slidebar"><img src="images/collapse.gif" alt="遊戲翻譯"  id="Img_8"  style="vertical-align:middle" onclick="SetExpand('8');"/>
...
<%--<table width="100%" class="leftmenutable" id="nine" runat="server">
  <tr>
    <td class="slidebar"><img src="images/collapse.gif" alt="遊戲翻譯"  id="Img_9"  style="vertical-align:middle" onclick="SetExpand('9');"/>
...
<table width="100%" class="leftmenutable" id="one" runat="server">
  <tr>
    <td class="slidebar"><img src="images/collapse.gif" alt="遊戲翻譯"  id="Img_1"  style="vertical-align:middle" onclick="SetExpand('1');"/>
...
<table width="100%" class="leftmenutable" id="secondstyle" runat="server">
  <tr> 
    <td class="slidebar"><img src="images/collapse.gif" alt="遊戲翻譯"  id="Img_2" style="vertical-align:middle"  onclick="SetExpand('2');"/><a href="#" onclick="SetExpand('2');">&nbsp;&nbsp;客戶實績</a></td>
  </tr>
  <tr>
...
<table width="100%" class="leftmenutable" id="thrid" runat="server">
  <tr> 
    <td class="slidebar"><img src="images/collapse.gif" alt="遊戲翻譯"  id="Img_3" style="vertical-align:middle" onclick="SetExpand('3');"/><a href="#" onclick="SetExpand('3');">&nbsp;&nbsp;用戶管理</a></td>
  </tr>
  <tr>
...
<%--<table width="100%" class="leftmenutable" id="four" runat="server">
  <tr> 
    <td class="slidebar"><img src="images/collapse.gif" alt="遊戲翻譯"  id="Img_4" style="vertical-align:middle"  onclick="SetExpand('4');"/><a href="#" onclick="SetExpand('4');">&nbsp;&nbsp;線上咨詢</a></td>
  </tr>
  <tr>
...
<%--<table width="100%" class="leftmenutable" id="six" runat="server"> 
  <tr>
    <td class="slidebar"><img src="images/expand.gif" alt="遊戲翻譯"  id="Img_6"  style="vertical-align:middle" onclick="SetExpand('1');"/><a onclick="SetExpand('6');" href="#" >&nbsp;&nbsp人才招募</a></td>
  </tr>
  <tr>
...
<table width="100%" class="leftmenutable" id="seven" runat="server">
  <tr> 
    <td class="slidebar"><img src="images/collapse.gif" alt="遊戲翻譯"  id="Img_7" style="vertical-align:middle"  onclick="SetExpand('7');"/><a href="#" onclick="SetExpand('7');">友好連結及合作夥伴</a></td>
  </tr>
  <tr>
...
<%--<table width="100%" class="leftmenutable" id="ten" runat="server">
  <tr> 
    <td class="slidebar"><img src="images/collapse.gif" alt="遊戲翻譯"  id="Img_11" style="vertical-align:middle"  onclick="SetExpand('11');"/><a href="#" onclick="SetExpand('11');">&nbsp;&nbsp;子網站管理</a></td>
  </tr>
  <tr>
