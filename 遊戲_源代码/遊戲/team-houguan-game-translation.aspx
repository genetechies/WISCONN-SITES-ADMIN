<%@ Page Language="C#" AutoEventWireup="true" CodeFile="team-houguan-game-translation.aspx.cs" Inherits="team_houguan_game_translation" %>
...
<head runat="server">
    ...
    <meta name="description" content="我們有著台灣最佳的遊戲翻譯團隊，專業、耐心及品質是我們的最大優勢，后冠遊戲翻譯也受到許多客戶的推薦！" />
    <meta name="keywords" content="遊戲翻譯 台灣,遊戲翻譯 推薦" />
    ...
    <!--[if lt IE 9]>
		...
		<![endif]-->
    <title>后冠翻譯社—台灣業界最推薦的遊戲翻譯公司</title>
</head>
<body>
    <form id="form1" runat="server">
        ...
        <div id="page">
            ...
            <div id="header">
                <div class="header_inner">
                    ...
                    <a class="logo" href="index-houguan-game-translation.aspx"><span style="display: inline-block; position: relative; width: 100%;">
                        <font style="color: #FFF; position: absolute; left: 78px; top: 34px;">翻譯團隊是翻譯社的靈魂，也是我們提供高品質遊戲翻譯的保證。</font>
                    </span>
                    </a>
            ...
            <!--<div class="wrap_cont_nav">
				<div class="cont_nav">
					<a href="translationteam.html">遊戲翻譯團隊</a>
				</div>
			</div>-->
                    ...
                    <div class="middle_inner">
                        ...
                        <div id="middle_content">
                            <div class="entry">
                                <div class="one_third">
                                    <div class="comment-body">
                                        ...
                                        <ul>
                                            ...
                                            %>
                                            <li><a href="team-houguan-game-translation.aspx?gid=<%=dsleft.Tables[0].Rows[i]["NC_Id"].ToString().Trim() %>" title="品質管理"><%=t[0].Trim()%></a></li>
                                            <%} %>
                                        </ul>
                                ...
                                <div class="two_third">
                                    <h3 style="font-weight:400;">后冠翻譯社的翻譯團隊由來自不同國家和地區的專業翻譯人員組成，因為專業所以自信，因為熱情所以耐心。這些精英是后冠的靈魂，也是我們敢於做出最佳翻譯承諾的自信來源。
                                    一直以來，我們靠著這些精英團隊獲得不少口碑，樹立了良好的形象。后冠精英團隊，隨時等待您的檢驗。
                                    </h3>
                                    <div class="logolist">
                                            ...
                                            <ItemTemplate>
                                                <div class="comment-body">
                                                    <table>
                                                        <tr>
                                                            <td>
                                                                <img src="<%#Eval("imgpath").ToString().Trim().Equals("") ? "" : Eval("imgpath")%>" alt="遊戲翻譯 英文" width="90" />
                                                            </td>
                                                            <td style="width: 12px;"></td>
                                                            <td style="vertical-align: top">
                                                                <div>
                                                                    <span>姓名： <%#Eval("tname").ToString().Trim().Equals("") ? "" : Eval("tname")%> </span>
                                                                    <br/>
                                                                    <span>性別： <%#Eval("avater").ToString().Trim().Equals("") ? "" : Eval("avater").ToString() == "0" ? "男" : "女"%> </span>
                                                                    
                                                                    <br/>
                                                                    <span>自我介紹：
                                                                        <%#Eval("descript").ToString().Trim().Equals("") ? "" : Eval("descript")%>
                                                                    </span>
                                                                </div>
                                                        </tr>
                                                    </table>
                                    ...
                                    <div id="AspNetPager1" runat="server">
