...
<head runat="server">
    ...
    <title><%=moarticle.ClassName%></title>
...
<div class="ban"> 
    ...
    <img src="../images/ban4.jpg" width="955" height="244" alt="翻譯公司 價格"/></div>
<!--主要内容-->
<div class="main">
    <div><img src="../images/page-top.gif" alt="翻譯公司 價錢"/></div>
<div class="page-middle">
<div style="width:945px; margin:0 auto">
  <div class="main_left">
    <h2 style="background:url(../images/hg_4_1.gif) left top no-repeat;">服務項目</h2>
  ...
  <div class="main_right">
    ...
    <div id="top-title" class="font26px">付款方式</div>
 <%=moarticle.D_Content %>
    </div>
  </div>
...
<div><img src="../images/page-bottom.gif" alt="翻譯公司 價錢"/></div>
