<%@ Page Language="C#" AutoEventWireup="true" CodeFile="transzone.aspx.cs" Inherits="transzone" %>
...
<title><%=moarticle.D_Title%> - 后冠翻譯公司</title>
...
<div class="ban"> 
    ...
    <img src="../images/ban9.jpg" width="955" height="244" alt="翻譯公司 - 翻譯公司最佳推薦"/></div>
<!--主要内容-->
<div class="main">
<div><img src="../images/page-top.gif" alt="翻譯公司"/></div>
<div class="page-middle">
<div style="width:945px; margin:0 auto">
  <div class="main_left">
   <h2 style="background:url(images/hg_2_01.gif) left top no-repeat;">翻譯領域</h2>
    <ul>
    <%System.Data.DataSet dsleft = new DAL.TransZone().GetAll();
      for (int i = 0; i < dsleft.Tables[0].Rows.Count; i++)
      {
         ...
         %>
     <li><a href="index-<%=dsleft.Tables[0].Rows[i]["NC_ID"].ToString().Trim() %>.aspx" onmousemove="changeMove(this,'<%=t[1].Trim() %>')" onmouseout="changeLeve(this,'<%=t[0].Trim() %>')" ><%=t[0].Trim()%></a></li>
      <%} %>
    ...
    <table width="699" border="0" cellspacing="0" cellpadding="0" align="center">
          <tr >
			...
			<div align="left" style="margin-top:10px; padding:10px;"> 
             ...
             <p style="padding-left:20px;">我們會不斷的提供最新的翻譯資訊，各篇文章也歡迎轉載，轉載時請您記得在文章結尾附上出處。附上出處的方式如下：
...
<div><img src="../images/page-bottom.gif" alt="翻譯公司"/></div>
