...
<meta name="description" content="后冠翻譯公司提供30多種的各國語言翻譯包含：中、英、日、韓、法、德、義、俄、越南、泰國、西班牙、葡萄牙、阿拉伯等語系及多元化的服務項目，包括筆譯、英文校稿、口譯、網頁翻譯、影視翻譯、公證文書、打字排版、聽打逐字稿、錄音配音、網站多語化等相關翻譯技術。 "/>
...
<div class="ban"> 
    ...
    <img src="../images/ban9.jpg" width="955" height="244" alt="英文 校稿"/></div>
<!--主要内容-->
<div class="main">
...
<div style="width:945px; margin:0 auto">
  <div class="main_left">
    <h2 style="background:url(images/hg_2_01.gif) left top no-repeat;">服務項目</h2>
    <h2 style="background:url(../images/hg_19_li2.gif) left top no-repeat; height:6px;">&nbsp;</h2>
    <ul>
    <%
        
System.Data.DataSet ds = new BLL.TransZone().GetAll();
...
<%} %>
  ...
  <div class="main_right2" style="width:700px">
    <div class="main_right_body4" style="width:700px">
    <div id="top-title" class="font26px" style="padding-left:10px;">翻譯領域<a style="padding-left:8px" target="_blank" title="" href="../rss/rss.aspx"><img src="../images/rss_bu.gif" alt="Rss"/></a></div>
    
    <div class="content-list">
    
<p> 后冠翻譯不斷精進，希望與您分享我們的成果，讓更多人瞭解！提供了許多翻譯相關的文章向是各個語言翻譯、英文校稿等等，文章歡迎自由轉載，並請附上出處：<br/>文章來源 ：<a href="https://www.houguan-translation-services.com/">后冠翻譯公司</a><a href="https://www.houguan-translation-services.com/">（https://www.houguan-translation-services.com/）</a>  </p>
<!--<img alt="" src="../images/t_18.jpg"/>-->
...
<a href="transzone-<%#Eval("D_ID") %>.aspx">
<b><%# Eval("D_Title")%></b>
</a>
</td>
