...
_st_dest="http://"+_st_ip+_st_dest+"&uv="+_st_uv+"&nuv="+_st_nuv+"&ss="+_st_ss+"&usn="+_st_url_sn+"&ec="+_en_co+"&ref="+_st_ref+"&url="+_st_url+"&nac="+_st_sof+"&agt="+_st_agt+"&clr="+_st_clr+"&scr="+_st_scr+"&lng="+_st_lng+"&jvm="+_st_jvm+"&flu="+_st_flu+"&tm=1338274890"+"&tc=c94d5760b1cf51bd64555a6f5974b0f2"+"&ut=0"+"&cnu="+_st_cva+"&jjj=1";
