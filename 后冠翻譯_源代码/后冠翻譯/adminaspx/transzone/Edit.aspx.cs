...
namespace adminaspx.transzone
{
    public partial class Edit : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            model = bll.GetModelNew(Convert.ToInt32(Request.QueryString["P_id"]));
            if (!IsPostBack)
            {
        ...
        protected void btnCloseAricle_Click(object sender, EventArgs e)
        {
            ...
            if (strKey != "")
            {
                if (strKey.Contains(","))
                {
                    ...
                    {
                        strContent += "<a href='http://www.houguan-translation-services.com/translationteam/index-" + table.Rows[i]["D_Id"].ToString() + ".aspx'>" + table.Rows[i]["D_Title"].ToString() + "</a> <br />";
                    }
                }
                else
                {
