...
<body>
    ...
    <tr>
    <td class="table_tittle" colspan="2">新增文章類別</td>
    </tr>
    <tr>
    ...
    <td  align="center">
       <asp:LinkButton ID="btnModfiy" runat="server" CommandArgument='<%#Eval("classid") %>' OnClick="btnModfiy_Click" >編輯</asp:LinkButton>&nbsp;&nbsp;
