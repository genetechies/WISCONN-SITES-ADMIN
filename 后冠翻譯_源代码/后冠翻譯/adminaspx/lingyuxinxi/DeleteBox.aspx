...
<body>
    ...
    <td align="center">
       [<asp:LinkButton ID="btnUnDel" runat="server" OnCommand="btnUnDel_Click" CommandArgument='<%#Eval("id") %>' >復原</asp:LinkButton>]
    </td>
    <td align="center">
           [<asp:LinkButton ID="Del" CommandArgument='<%#Eval("id") %>' runat="server" OnCommand="Del_Click" OnClientClick="return confirm('確定要徹底刪除嗎?');">徹底刪除</asp:LinkButton>]
    </td>
    </tr>
    </ItemTemplate>
    </asp:Repeater>
