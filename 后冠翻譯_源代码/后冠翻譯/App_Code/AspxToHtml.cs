...
public class AspxToHtml
{
    ...
    public void WriteFile(string htmlName)
    {
        ...
        if (friendlytable != null && friendlytable.Rows.Count > 0)
        {
            ...
            {
               // if (i != 0 && i % 7 == 0)
                //    FriendlyName += "</tr><tr><td style='border:0px;' align='left'><div class='icon1'><a href='http://" + friendlytable.Rows[i][2].ToString() + "' target='_blank' title='" + friendlytable.Rows[i][1].ToString() + "'><font style='font-family: 'Verdana', 'Helvetica san-serif''>" + friendlytable.Rows[i][1].ToString() + "</font></a></div></td> ";
               // else
                //    FriendlyName += "<td  style='border:0px;width:135px;' align='left'><div class='icon1'><a href='http://" + friendlytable.Rows[i][2].ToString() + "' target='_blank' title='" + friendlytable.Rows[i][1].ToString() + "'><font style='font-family: 'Verdana', 'Helvetica san-serif''>" + friendlytable.Rows[i][1].ToString() + "</font></a></div></td> ";
                if (i != 0 && i % 7 == 0)
                    FriendlyName += "</tr><tr><td style='border:0px;' align='left'><div class='icon1'><a href='http://" + friendlytable.Rows[i][2].ToString() + "' target='_blank' title='" + friendlytable.Rows[i][1].ToString() + "'><span class='fontstyle'>" + friendlytable.Rows[i][1].ToString() + "</span></a></div></td> ";
                else
                    FriendlyName += "<td  style='border:0px;width:135px;' align='left'><div class='icon1'><a href='http://" + friendlytable.Rows[i][2].ToString() + "' target='_blank' title='" + friendlytable.Rows[i][1].ToString() + "'><span class='fontstyle'>" + friendlytable.Rows[i][1].ToString() + "</span></a></div></td> ";
        ...
        if (partnerstable != null && partnerstable.Rows.Count > 0)
        {
            ...
            {
                if (i != 0 && i % 7 == 0)
                    PartnersName += "</tr><tr><td  style='border:0px;' align='left'><div class='icon1'><a href='http://" + partnerstable.Rows[i][2].ToString() + "' target='_blank' title='" + partnerstable.Rows[i][1].ToString() + "'><span class='fontstyle'>" + partnerstable.Rows[i][1].ToString() + "</span></a></div></td> ";
                else
                    PartnersName += "<td align='left' style='border:0px;width:135px;'><div class='icon1'><a href='http://" + partnerstable.Rows[i][2].ToString() + "' target='_blank' title='" + partnerstable.Rows[i][1].ToString() + "'><span class='fontstyle'>" + partnerstable.Rows[i][1].ToString() + "</span></a></div></td>";
            }
        }
