<%@ Page Language="C#" AutoEventWireup="true" CodeFile="transzonetype.aspx.cs" Inherits="transzonetype" %>
...
<body>
    ...
    <td  align="center">
       <asp:LinkButton ID="btnModfiy" runat="server" CommandArgument='<%#Eval("NC_Id") %>' OnClick="btnModfiy_Click" >編輯</asp:LinkButton>&nbsp;&nbsp;
