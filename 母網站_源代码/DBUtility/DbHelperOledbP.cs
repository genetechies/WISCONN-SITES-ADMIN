...
namespace DBUtility
{
    public class DbHelperOledbP
    {

        //数据库连接字符串(web.config来配置)，可以动态更改connectionString支持多数据库.		
        public static string connectionString = "";
        public DbHelperOledbP(Model.SubWeb sw)
        {
            connectionString = new PubConstant().GetString(sw);
        }
        ...
        /// <returns>影响的记录数</returns>
        public  int ExecuteSqlAlertTable(string SQLString, string connectionString)
        {
            using (SqlConnection connection = new SqlConnection(connectionString))
            {
                using (SqlCommand cmd = new SqlCommand(SQLString, connection))
        ...
        public  string GetMaxStringID(string FieldName, string TableName)
        {
        ...
        public  int ExecuteSql(string SQLString, string content)
        {
            using (SqlConnection connection = new SqlConnection(connectionString))
            {
                ...
                System.Data.SqlClient.SqlParameter myParameter = new System.Data.SqlClient.SqlParameter("@content", SqlDbType.Variant);
        ...
        public  int ExecuteScalar(string SQLString, string content)
        {
            using (SqlConnection connection = new SqlConnection(connectionString))
            {
                SqlCommand cmd = new SqlCommand(SQLString, connection);
        ...
        /// <returns></returns>
        public  int GetMainKey(string SQLString, string FieldName, string TableName)
        {
            using (SqlConnection connection = new SqlConnection(connectionString))
            {
                using (SqlCommand cmd = new SqlCommand(SQLString, connection))
        ...
        /// <returns></returns>
        public  int ExecuteScalar(string SQLString, params SqlParameter[] cmdParms)
        {
            using (SqlConnection connection = new SqlConnection(connectionString))
            {
                using (SqlCommand cmd = new SqlCommand())
