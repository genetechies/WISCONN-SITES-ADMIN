...
namespace Helper
{
    public class MyTool
    {
        ...
        /// <summary>
        /// 上传文件格式验证 doc|docx|xls|jpg|jpeg|tiff|png|gif|pdf|zip|rar
        /// </summary>
        /// <param name="strIn"></param>
        /// <returns></returns>
        ...
        {
            return Regex.IsMatch(strIn, @"\.(?i:doc|docx|xls|jpg|jpeg|tiff|png|gif|pdf|zip|rar)$");
        }
        ...
        public static string TrimName(string username) {
            string outname = username;
        ...
        public static string StripSpecialSymbol(string str)
        {
            ...
            {
                //Regex regex = new Regex(arySymbol[i], RegexOptions.IgnoreCase);
