<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Add.aspx.cs" Inherits="Admin_Friendly_Add" %>
...
<body>
    ...
    <tr>
    <td class="table_tittle" colspan="2">新增友好連結</td>
    </tr>
    <tr>
    <td  align="right" class="style1">發佈網站：</td>
    <td  align="left">
      ...
      <td align="left">
         &nbsp;<asp:RadioButton ID="LRadio1" GroupName="LocationRadio" 
          ...
          &nbsp;&nbsp;<asp:RadioButton ID="LRadio2"  GroupName="LocationRadio" 
              ...
              runat="server" Text="友好連結及首頁" />
              &nbsp;&nbsp;<asp:RadioButton ID="LRadio5" GroupName="LocationRadio" runat="server"
                        Text="其它頁" />
