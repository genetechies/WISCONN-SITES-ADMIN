...
public partial class Admin_Friendly_outfriendly : System.Web.UI.Page
{
    ...
    */
    protected void btnImportOut_Click(object sender, EventArgs e)
    {
        ...
        string filename = ExportDataToExcel(bll.GetList("",new CbxSubwebSingle().GetWebModel()).Tables[0], Server.MapPath("~/data/"), nameList, "");
    ...
    {
        DataSet ds = bll.GetList("", new CbxSubwebSingle().GetWebModel());
        string data = "";
        //data = ds.DataSetName + "\n";
