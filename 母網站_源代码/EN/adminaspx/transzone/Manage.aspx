...
<body>
    ...
    <table class="table_main" cellpadding="0" cellspacing="1" id="t_list">
    <tr>
    <td class="table_tittle"  colspan="7">文章列表管理</td>
    ...
    <td><a href="/translation/transzone-<%#Eval("D_ID") %>.aspx" target="_blank"><%#Eval("D_Title")%></a></td>
    ...
    <td align="center"><%# Eval("WebSite", "{0:yyyy-MM-dd}")%>&nbsp;</td>
    <td>
    ...
    <td align="center">						
        <a href="Edit.aspx?P_id=<%#Eval("D_ID")+","+Eval("Swid") %>" title="編輯"   >編輯</a>&nbsp;&nbsp;
    </td>
    <td align="center">
        <asp:LinkButton ID="Del" CommandArgument='<%#Eval("D_ID")+","+Eval("Swid") %>' runat="server" OnClick="Del_Click" OnClientClick="return confirm('確定要刪除嗎?');" ToolTip="刪除" Text="刪除"></asp:LinkButton>
    </td>
    </tr>
    </ItemTemplate>
    </asp:Repeater>
