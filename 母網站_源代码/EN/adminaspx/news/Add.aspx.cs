...
namespace Web.Admin.News
{
    public partial class Add : System.Web.UI.Page
    {
        ...
        protected void Sub_Click(object sender, EventArgs e)
        {
                    ...
                    model.D_Content = txtEditorContents.Text;//.Value;
                    model.D_Recycle = 0;
                    model.OrderID = 0;
                    string msg = "以下网址添加失败：";
                    try
        ...
        protected void btnCloseAricle_Click(object sender, EventArgs e)
        {
            ...
            if (strKey != "")
            {
                if (strKey.Contains(","))
                {
                    ...
                    {
                        strContent += "<a href='http://translation.crowns.com.tw/translation/newsinfo-" + table.Rows[i]["D_Id"].ToString() + ".aspx'>" + table.Rows[i]["D_Title"].ToString() + "</a> <br />";
                    }
                }
                else
                {
