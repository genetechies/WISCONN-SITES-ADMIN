    ...
    public partial class Manage : System.Web.UI.Page {
        ...
        protected void Page_Load(object sender, EventArgs e) {
            if (!IsPostBack) {
                ...
                if (!Utils.IsRight(Session["Admin"].ToString(), "jbnews", RightStatus.Select))
                {
                ...
                Where = " ( parentid=1 or parentid=2 ) ";   // parentid=1關於后冠 2,服務項目,
        ...
        protected void Button2_Click(object sender, EventArgs e)   //查询
        {
            ...
            {
                Where = "( parentid=1 or parentid=2 ) and ( ClassName like '%" + searchText1.Text + "%' or D_Content like '%" + searchText1.Text + "%') ";
            }
            else
            {
