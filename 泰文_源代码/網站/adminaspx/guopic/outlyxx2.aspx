<%@ Page Language="C#" AutoEventWireup="true" CodeFile="outlyxx2.aspx.cs" Inherits="Web.Admin.GuestBook.Manage" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>匯出LOGO圖信息</title>
...
<body>
   ...
   <div style="line-height:18px;"><b>(1)</b> EXCEL可批量下載目前所有該欄目的信息;</div>
   </td>
		</tr>
	</table>
		</td></tr>
