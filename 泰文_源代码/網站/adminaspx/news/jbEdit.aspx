<%@ Page Language="C#" AutoEventWireup="true" ValidateRequest="false" CodeFile="jbEdit.aspx.cs" Inherits="Web.Admin.News.Edit" %>
...
<table class="table_main">
    <tr>
    <td class="table_tittle" colspan="2">編輯網頁</td>
    </tr>
    <tr>
    <td  align="right" width="10%">標題：</td>
    <td  align="left">
        <asp:TextBox ID="txtTitle" runat="server" MaxLength="50" Width="350px" /> 
        <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="txtTitle"  ErrorMessage="*"></asp:RequiredFieldValidator>如有英文標題請用&quot;|&quot;分開</td>
    </tr>
