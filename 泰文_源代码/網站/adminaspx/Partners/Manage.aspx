...
<body>
    ...
    <tr>
        <td colspan="2" style="height:30px;line-height:30px;" >發佈網站</td>
...
<%--        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="#" onmousemove="showDiv('downindex.html')" onmouseout="hideDiv('downindex.html')"> 首頁 </a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <a href="#" onmousemove="showDiv('downlink.html')" onmouseout="hideDiv('downlink.html')"> 友好連結 </a> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <a href="#" onmousemove="showDiv('downother.html')" onmouseout="hideDiv('downother.html')"> 其它頁面  </a>--%>
  ...
  <%--  <td align="center">修改時間</td>
    ...
    <ItemTemplate>
    <tr>
    <td align="center" width="35"><asp:CheckBox ID="cbSelect" runat="server" /><asp:Label ID="lblNID" runat="server" Visible="false" Text='<%#Eval("F_Id") %>' ></asp:Label><asp:Label ID="lblLCTION" runat="server" Visible="false" Text='<%#Eval("F_Location")+"|"+Eval("SwId")%>' ></asp:Label></td>
...
<%--    <td align="center"><%#Eval("F_OptionTime","{0:yyyy-MM-dd}") %></td>
    <td align="center"><%#Eval("database", "{0:yyyy-MM-dd}")%></td>--%>
    <td align="center">
