...
public partial class houguan_Thailand_online_price : System.Web.UI.Page
{
    ...
    private void SendMsg()
    {
        ...
        {
            Response.Redirect("houguan-Thailand-contact.html");
        }
        //1小時內提交超過10次加入黑名單
        if (CheckIP(ip) >= 10)
        {
        ...
        try
        {
            ...
            using (SqlConnection conn = new SqlConnection(PubConstant.ConnectionString))
            {
                ...
                cmd.Parameters.AddWithValue("@Note", "來自泰文站點");
            ...
            MyTool.alert("感謝您的詢價，我們已收到，會儘速請報價專員與您聯絡！", "houguan-Thailand-index.aspx");
