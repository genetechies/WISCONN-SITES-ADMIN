...
public partial class rss_rss : System.Web.UI.Page
{
    ...
    public void BindRss()
    {
        ...
        channel.Link = @"http://translation.crowns.com.tw/translation/";
        ...
        for (int i = 0; i < table.Rows.Count; i++)
        {
            ...
            item.Link = @"http://translation.crowns.com.tw/translation/Newlist-" + table.Rows[i]["classid"].ToString().Trim() + ".aspx";
