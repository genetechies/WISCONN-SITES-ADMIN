...
<body>
    ...
    <div>
            <table class="table_main">
                ...
                <%--<tr>
                    <td align="right" width="10%">網站權限：</td>
                    <td align="left">
        <asp:CheckBoxList ID="cbxWeb" runat="server" RepeatDirection="Horizontal">
            ...
            <%--    <tr>
                ...
                <tr>
                    <td align="right" width="10%">服務項目類別管理權限：</td>
                    <td align="left">
               ...
               <tr>
                    <td align="right" width="10%">洲類別管理權限：</td>
                    <td align="left">
               ...
               <%-- <tr>
                ...
                <tr>
                 ...
                 <%--<tr>
                    <td align="right" width="10%">子網站管理：</td>
                    <td align="left">
                        <asp:CheckBox ID="cbSwInsert" runat="server" Text="新增" />&nbsp;&nbsp;&nbsp;
                        <asp:CheckBox ID="cbSwDelete" runat="server" Text="刪除" />&nbsp;&nbsp;&nbsp;
                        <asp:CheckBox ID="cbSwUpdate" runat="server" Text="修改" />&nbsp;&nbsp;&nbsp;
                        <asp:CheckBox ID="cbSwSelect" runat="server" Text="查詢" />&nbsp;&nbsp;&nbsp;
                    </td>
                </tr>--%>
                <tr>
