<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Importlyxx2.aspx.cs" Inherits="Web.Admin.Product.ImportOut" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml" >
<head runat="server">
    <title>匯入LOGO圖信息</title>
...
<body leftmargin="10" topmargin="10" marginwidth="10" marginheight="10">
   <div class="BodyRight">
	...
	<form name="theForm" method="post" action="?action=importinsert">
    ...
    if (table != null && table.Rows.Count > 0)
    {
		...
		<tr style="line-height:27px;">
			...
			<td><input type="text" class="FormSmall" style="width:110px;height:65px;" name="pname[<%=i.ToString() %>]" value="<%=row[3].ToString() %>" /></td>
		</tr>
		<%
    i++;
        }
	...
	<form action="?action=importconfirm" enctype="multipart/form-data" method="post" name="theForm" onsubmit="return doSubmit()">
	...
	<table width="100%" border="0" cellspacing="0" cellpadding="0" class="table_main" style="margin-top:10px;">
		...
		<tr class="secondalt">
			<td><span style="padding-left:10px;">上傳批量Excel文件</span></td>
   ...
   <div style="line-height:18px;"><b>(2)</b> 填寫Excel文件,可以使用Excel打開下載的模版文件;<br />
     &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;圖片請直接填寫圖片檔案名,無需帶路徑,如：abc.jpg;</div>
   <div style="line-height:18px;"><b>(3)</b> 將填寫的圖片通過圖片上傳功能上傳到伺服器;<br />
   <div><b>(4)</b> 上傳Excel文件</div>
   <br />
		</tr>
	</table>
		</td></tr>
