...
public partial class japanese_houguan_translation_detail : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!IsPostBack)
        {
            ...
            {
                Response.Redirect("japanese-houguan-translation-index.aspx");
            }
            Bindlist();
        }
    }
    ...
    private void BindModel(int id)
    {
        ...
        Title = "[" + newsClass.ClassName + "]" + model.D_Title + "-后冠日文翻譯公司";
    }
    ...
    private void Bindlist()
    {
        ...
        for (int i = 0; i < ds.Tables[0].Rows.Count; i++)
        {
            ...
            NewsList += "<li><a href=\"japanese-houguan-translation-detail.aspx?id=" + ds.Tables[0].Rows[i]["D_ID"].ToString() + "\">" + title + "</a></li>";
        }
    }
    ...
    private void BindSimilar(int id)
    {
        ...
        if (ds.Tables[0].Rows.Count > 0)
        {
            for (int i = 0; i < ds.Tables[0].Rows.Count; i++)
            {
                SimilarNews += "<a href=\"japanese-houguan-translation-detail.aspx?id=" + ds.Tables[0].Rows[i]["D_ID"].ToString() + "\" >" + ds.Tables[0].Rows[i]["D_Title"].ToString() + "</a> <br />";
            }
        }
    ...
    private void BindNext(int id)
    {
        ...
        {
            NextNews = "<a href=\"japanese-houguan-translation-detail.aspx?id=" + ds1.Tables[0].Rows[0]["D_ID"].ToString() + "\" >" + ds1.Tables[0].Rows[0]["D_Title"].ToString() + "</a>";
        }
        else
        {
        ...
        {
            LastNews = "<a href=\"japanese-houguan-translation-detail.aspx?id=" + ds2.Tables[0].Rows[0]["D_ID"].ToString() + "\" >" + ds2.Tables[0].Rows[0]["D_Title"].ToString() + "</a>";
        }
        else
        {
