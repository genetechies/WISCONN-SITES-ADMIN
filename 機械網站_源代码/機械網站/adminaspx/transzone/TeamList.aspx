...
<body>
    ...
    <table class="table_textcenter">
     <tr>
        <td class="table_tittle"  colspan="6">翻譯團隊列表管理</td>
        <td><strong><a href="TeamEdit.aspx" >>>新增翻譯團隊</a></strong></td>
    </tr>
    <tr>    
        <td style="height:30px;line-height:30px; width:60px; text-align:left">發佈網站：</td>
        <td colspan="6" style="height:30px;line-height:30px; text-align:left">
  ...
  <%--  <td align="center" style="font-weight:bold" >LOGO小圖排序</td>
    <td align="center" style="font-weight:bold" >資料庫</td>--%>
    ...
    <%--<td  align="center">
        ...
        <asp:Label ID="lbSwId" runat="server" Text='<%# Eval("SwId") %>' Visible="false"></asp:Label>
        <asp:TextBox ID="txtSort" runat="server" Width="40px" Text='<%# Eval("sort")+"|"+Eval("SwId") %>' ></asp:TextBox>
...
<%--   <td  align="center"><%#Eval("Database")%></td>--%>
    ...
    <td  align="center">
        ...
        <a href="TeamEdit.aspx?P_id=<%#Eval("tid") %>&SwId=<%#Eval("SwId") %>" title="編輯"   >編輯</a>&nbsp;&nbsp;
       <asp:LinkButton ID="LinkButton1" CommandName='<%#Eval("tid")+","+Eval("SwId") %>'
