...
public partial class quotation_translation_mechanical : System.Web.UI.Page
{
    ...
    protected void btnSubmit_Click(object sender, EventArgs e)
    {
        ...
        {
            Response.Redirect("contact-translation-mechanical.html");
        }
        //1小時內提交超過10次加入黑名單
        if (CheckIP(ip) >= 10)
        {
        ...
        try
        {
            ...
            using (SqlConnection conn = new SqlConnection(PubConstant.ConnectionString))
            {
                ...
                cmd.Parameters.AddWithValue("@Note", "來自机械站點");
                //cmd.ExecuteNonQuery();
            ...
            MyTool.alert("感謝您的詢價，我們已收到，會儘速請報價專員與您聯絡！", "quotation-translation-mechanical.aspx");
