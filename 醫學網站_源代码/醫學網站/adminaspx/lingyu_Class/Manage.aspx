    ...
    <form id="form1" runat="server">
        <div>
            <table class="table_main">
                <tr>
                    <td class="table_tittle" colspan="2">新增洲類別</td>
                </tr>
                <tr>
                    <td class="table_tittle" colspan="2">
                        <asp:CheckBoxList ID="cbxWeb" runat="server" RepeatDirection="Horizontal">
                        </asp:CheckBoxList></td>
                </tr>
                <tr>
                    <td align="right" width="40%">洲類別名稱：</td>
                    <td align="left">
                ...
                <%--<tr>
    <td align="right" width="40%">所屬國家：</td>
    <td align="left">
        <asp:DropDownList ID="ddl_guoclass" runat="server">
                ...
                <tr>
                    <td align="right" width="40%">洲類別排序：</td>
                ...
                <tr>
                    ...
                    <td align="left">
                        <asp:TextBox ID="tbDescrition" runat="server" MaxLength="40" Columns="25"
                                     Width="224px" />
                    </td>
                </tr>
                <tr>
        ...
        <asp:Button ID="btnReset" runat="server" Text="重置" OnClick="btnReset_Click" />
            ...
            <table class="table_textcenter">
                <tr>
                    ...
                    <td align="center" width="30%" style="font-weight: bold">洲類別名稱</td>
                    <td align="center" style="font-weight: bold">洲類別排序</td>
