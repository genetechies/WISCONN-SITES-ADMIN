...
<body>
    ...
    <tr>
    <td class="table_tittle"  colspan="9">文章列表管理</td>
    <td><strong><a href="add.aspx" >>>新增文章</a></strong></td>
    </tr>
    <tr>
        <td colspan="2" style="height:30px;line-height:30px; width:60px " >發佈網站：</td>
    ...
    <tr>
        <td colspan="10" style="height:30px;line-height:30px;" >標題：
        ...
        欄位：<asp:DropDownList ID="ddlCategory" runat="server" >
		             ...
		             &nbsp;管理員：<asp:TextBox ID="txtInput" runat="server" ></asp:TextBox>&nbsp;&nbsp;&nbsp;修改者：<asp:TextBox ID="txtModfiy" runat="server"></asp:TextBox>
            <asp:Button 
                        ID="Button2" runat="server" Text="查詢" onclick="Button2_Click" /></td>
    </tr>
    <tr>
    <td align="center" width="35">選擇</td>
    <td align="center" width="35%" colspan="2">標題</td>
    <td align="center" colspan="2">欄位分類</td>
    <td align="center" colspan="2">管理員</td>
    ...
    <td align="center">						
        <a href="Edit.aspx?P_id=<%#Eval("D_ID") %>" title="編輯"   >編輯</a>&nbsp;&nbsp;
    </td>
    <td align="center">
        <asp:LinkButton ID="Del" CommandArgument='<%#Eval("D_ID") %>' runat="server" OnClick="Del_Click" OnClientClick="return confirm('確定要刪除嗎?');" ToolTip="刪除" Text="刪除"></asp:LinkButton>
    </td>
    </tr>
    </ItemTemplate>
    </asp:Repeater>
    <tr>
       <td colspan="10" align="right"> <input type="checkbox" onclick="SelectAll(this);" />全選
