<%@ Page Language="C#" AutoEventWireup="true" CodeFile="DeleteBox.aspx.cs" Inherits="Web.Admin.News.DeleteBox" %>
...
<body>
    ...
    <tr>
    <td class="table_tittle"  colspan="8">文章回收桶</td>
    </tr>
    <tr>
    ...
    <ItemTemplate>
    <tr>
    <td align="center" width="45"><asp:CheckBox ID="cbSelect" runat="server" /><asp:Label ID="lblNID" runat="server" Visible="false" Text='<%#Eval("D_ID") %>' ></asp:Label>
    <asp:Label ID="lbSwId" runat="server" Visible="false" Text='<%#Eval("SwId") %>' ></asp:Label>
    </td>
    ...
    <td align="center">
       [<asp:LinkButton ID="btnUnDel" runat="server" OnCommand="btnUnDel_Click" CommandArgument='<%#Eval("D_ID_SwId") %>' >復原</asp:LinkButton>]
    </td>
    <td align="center">
           [<asp:LinkButton ID="Del" CommandArgument='<%#Eval("D_ID_SwId") %>' runat="server" OnCommand="Del_Click" OnClientClick="return confirm('確定要徹底刪除嗎?');">徹底刪除</asp:LinkButton>]
    </td>
    </tr>
    </ItemTemplate>
    </asp:Repeater>
